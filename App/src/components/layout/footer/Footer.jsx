    ...
    <footer className='footer'>
      <div className='footer__container container'>
        ...
        <div className='footer__social'>
          <a href='https://www.linkedin.com/in/alitago' className='footer__social-link' target='_blank' rel='noreferrer'><i className='bx bxl-linkedin' /></a>
          <a href='https://github.com/alitfal' className='footer__social-link' target='_blank' rel='noreferrer'><i className='bx bxl-github' /></a>
          ...
          <a href='https://paypal.me/alitago' className='footer__social-link' target='_blank' rel='noreferrer'><i className='bx bxl-paypal' /></a>
        </div>
